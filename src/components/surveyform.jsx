      ...
      <div className="card-panel card-relative">
        ...
        >
          ...
          <select
            ...
            id="respondent_gender"
            className="select_els"
            {...register("respondent_gender")}
          >
          ...
          />
          <label htmlFor="respondent_wheeler">
            5. How many 3 wheeler or 2 wheeler per stand?
          </label>
          <input
            className="input"
            type="text"
          ...
          <label htmlFor="brand_category_1">
            1. What comes into your mind if you hear of the word ORYX?
          </label>
          <input
            className="input"
            type="text"
          ...
          <label htmlFor="brand_category_2">
            2. Have you ever used ORYX Lubricants?
          </label>
          <select
            name="brand_category_2"
            id="brand_category_2"
            className="select_els select_parent"
            {...register("brand_category_2")}
            onChange={(e) => handleNonUser(e)}
          >
            <option value="">Select your answer</option>
            <option id="yes_user_item" value="yes">
              YES
            </option>
            <option id="no_user_item" value="no">
              NO
            </option>
          </select>

          {valueCheck.number_Two === "no" ? (
            <div id="non_user" className="mt-tops">
              <label htmlFor="brand_category_2_a">
                2a. If not, Why? and are you willing to use?
              </label>
              <input
              ...
              />
              <label htmlFor="brand_category_3">
                3. To non-users, Which brand of lubricants are you using?
              </label>
              <input
                className="input authonticate_values"
                type="text"
          ...
          {valueCheck.number_Two === "yes" ? (
            <div id="user_yes" className="mt-tops">
              <label htmlFor="brand_category_2_b">
                2b. If yes, Mention one product from ORYX that you normally use?
              </label>
              <input
                className="input authonticate_values"
                type="text"
          ...
          <label htmlFor="brand_category_4">
            4. What do you like from the brand you are currently using?
          </label>
          <input
            className="input"
            type="text"
          ...
          />
          <label htmlFor="brand_category_5">
            5. For how long have you be using the brand?
          </label>
          <input
            className="input"
            type="text"
          ...
          />
          <label htmlFor="brand_category_6">
            6. How did you come to choosing the brand you are currently using?
          </label>
          <select
            name="brand_category_6"
            id="brand_category_6"
            className="select_els select_parent"
          ...
          >
            ...
            <option value="Visited a physical store">
              Visited a physical store
            </option>
            <option id="water_bottle" value="Other">
              Other
            </option>
          </select>

          {valueCheck.number_six === "Other" ? (
            <div className="mt-tops" id="specify_user">
          ...
          <label htmlFor="brand_category_8">
            7. What other names of the lubricants brands do you remember?
          </label>
          <input
            className="input"
            type="text"
          ...
          />
          <label htmlFor="brand_category_9">
            8. How often do you change your oil on the 3wheeler or 2wheeler?
          </label>
          <input
            className="input"
            type="text"
          ...
          <label htmlFor="distribution_9">
            9. Where do you purchase your lubricants?
          </label>
          <input
            className="input"
            type="text"
          ...
          />
          <label htmlFor="distribution_10">
            10. Do they provide services or just selling the product?
          </label>
          <select
            name="distribution_10"
            id="distribution_10"
            className="select_els"
          ...
          <label htmlFor="area_of_service_11">
            11. Where do you service your Boda Boda or Bajaj?
          </label>
          <input
            className="input"
            type="text"
          ...
          />
          <label htmlFor="area_of_service_12">
            12. The oil brand that you use, is it decided by you or the
            mechanic?
          </label>
          <select
            name="area_of_service_12"
            id="area_of_service_12"
            className="select_els select_parent"
          ...
          >
            ...
            <option id="mechanic_item" value="By mechanic">
              By mechanic
            </option>
          </select>

          {valueCheck.number_twelve === "By mechanic" ? (
            <div className="mt-tops" id="mechanic_users">
              <label htmlFor="area_of_service_13">
                13. Does the mechanic sell the lubricants at his store?
              </label>
              <select
                name="area_of_service_13"
                id="area_of_service_13"
                className="select_els authonticate_values"
          ...
          <label htmlFor="media_consumption_14">
            14. Have you ever heard of any lubricant radio or TV adverts?
          </label>
          <select
            name="media_consumption_14"
            id="media_consumption_14"
            className="select_els select_parent"
            {...register("media_consumption_14")}
            onChange={(e) => handleNumFourteen(e)}
          >
            <option value="">Select your answer</option>
            <option id="yes_advert" value="yes">
              YES
            </option>
            <option id="no_advert" value="no">
              NO
            </option>
          </select>

          {valueCheck.number_fourteen == "yes" ? (
            <div id="tv_adverts" className="mt-tops">
              <label htmlFor="media_consumption_15">
                15. In which Radio or TV station have you heard or seen the
                advert?
              </label>
              <input
                className="input authonticate_values"
              ...
              <label htmlFor="media_consumption_16">
                16. Can you recall the advert name or offer attached to the
                Adverts?
              </label>
              <input
                className="input authonticate_values"
              ...
              />
              <label htmlFor="media_consumption_17">
                17. Which brand was the advert about?
              </label>
              <input
                className="input authonticate_values"
                type="text"
